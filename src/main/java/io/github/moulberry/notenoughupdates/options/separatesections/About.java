/*
 * Copyright (C) 2024-2026 NotEnoughUpdates contributors
 */
...
public class About {
	...
	public static class Licenses {
		...
		@ConfigOption(name = "Fabric", desc = "Fabric is available under the Apache 2.0 license")
		@ConfigEditorButton(buttonText = "Source")
		public Runnable fabric = () -> Utils.openUrl("https://github.com/FabricMC");
